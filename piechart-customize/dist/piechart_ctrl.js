        ...
        _createClass(PieChartCtrl, [{
          ...
          value: function onDataReceived(dataList) {
            ...
            for (var i=0;i<dataList[0]["rows"].length;i++) {
              tempdata.push( '{"target":"'+dataList[0]['rows'][i][0]+'","datapoints":[['+dataList[0]['rows'][i][1]+',22]],"refId":"A","meta":{"rowCount":2 }}');
            }
            tempdata = '['+tempdata+']';
            console.log(tempdata+'tempaaaaaaa');
            console.log(typeof tempdata);

            var ta = JSON.parse(tempdata);
          ...
          value: function seriesHandler(seriesData) {
            ...
            console.log(JSON.stringify(seriesData)+'seriesdata');

            series.flotpairs = series.getFlotPairs(this.panel.nullPointMode);
            console.log(series.flotpairs+'flo');
            // series.flotpairs
            return series;
          }
        }, {
